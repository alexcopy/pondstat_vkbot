package ru.gpsbox.vkbot;

import ru.gpsbox.vkbot.config.ApplicationProperties;
import ru.gpsbox.vkbot.config.DefaultProfileUtil;
...
public class VkbotApp {
    ...
    public VkbotApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(VkbotApp.class);
