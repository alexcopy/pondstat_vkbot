[![Build Status](https://travis-ci.org/alexcopy/pondstat_vkbot.svg?branch=master)](https://travis-ci.org/alexcopy/pondstat_vkbot)
...
To optimize the vkbot application for production, run:
